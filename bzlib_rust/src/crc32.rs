...
#[no_mangle]
pub unsafe extern "C" fn BZ2_initialise_crc(crc_var: &mut u32) {
    *crc_var = 0xffffffff;
}

#[no_mangle]
pub unsafe extern "C" fn BZ2_finalise_crc(crc_var: &mut u32) {
    *crc_var = !(*crc_var);
}
...
mod tests {
    ...
    // This is an experiment in computing the same values as the
